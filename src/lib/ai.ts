...
export const MODELS = {
	...
	ADVISOR: "gpt-4o-mini", // Cost-effective model for the advisor
};
 ...
 */
export function buildAdvisorPrompt(contextItems: any[]) {
	let contextString = "Below is information retrieved from the Intimera relationship library:\n\n";
	...
	return `
You are the Intimera AI Relationship Advisor. You are a compassionate, evidence-based relationship counselor. 
...
2. Ground your advice in the provided Intimera Library Content when relevant.
